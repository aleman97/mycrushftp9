...
panelEncryption.bindEvents = function() {
    ...
    $("a#testCertificate", _panel).click(function(evt, param) {
        ...
        var obj = {
            ...
            keystorePath: certPath.hasClass('urlWithParams') ? decodeURIComponent($("#cert_path", _panel).data("realURL")) : crushFTP.methods.htmlEncode($("#cert_path", _panel).val()),
