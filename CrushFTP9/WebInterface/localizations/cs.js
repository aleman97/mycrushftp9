...
localizations.currentLanguageName = "Czech";
localizations.languageNameEnglish = "English";
localizations.languageNameCzech = "Czech";
localizations.languageNameDanish = "Danish";
localizations.languageNameDutch = "Dutch";
localizations.languageNameFrench = "French";
localizations.languageNameGerman = "German";
localizations.languageNameHungarian = "Hungarian";
localizations.languageNameItalian = "Italian";
localizations.languageNamePolish = "Polish";
localizations.languageNameSpanish = "Spanish";
localizations.languageNameSlovak = "Slovak";
localizations.languageNameChinese = "Chinese";
localizations.languageNameSwedish = "Swedish";
