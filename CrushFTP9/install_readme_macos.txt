If you didn't download CrushFTP with Java, you need to donwlaod Java first before you can launch CrushFTP.  https://jdk.java.net/
Unzip the latest version, and take the "Home" folder from inside the Contents folder and rename it to "Java".  Place this Java folder in the CrushFTP9 folder.
(This folder has the subfolders bin, lib, conf, etc.)

Move the CrushFTP9 folder to your Applications folder.
--------------------------------------------------
